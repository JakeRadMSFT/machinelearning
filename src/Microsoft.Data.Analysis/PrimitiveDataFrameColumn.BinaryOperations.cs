            ...
            where U : unmanaged
        {
            ...
            switch (typeof(T))
            {
                case Type boolType when boolType == typeof(bool):
                    ...
                    return new PrimitiveDataFrameColumn<bool>(Name, (this as PrimitiveDataFrameColumn<U>)._columnContainer.ElementwiseEquals(column._columnContainer));
                case Type decimalType when decimalType == typeof(decimal):
                    if (typeof(U) == typeof(bool))
                    {
                        throw new NotSupportedException();
                    ...
                    if (typeof(U) == typeof(T))
                    {
                        // No conversions
                        PrimitiveDataFrameColumn<U> primitiveColumn = this as PrimitiveDataFrameColumn<U>;
                        return new PrimitiveDataFrameColumn<bool>(Name, primitiveColumn._columnContainer.ElementwiseEquals(column._columnContainer));
                    }
                    else
                    {
                        PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                        return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseEquals(column.CloneTruncating<decimal>()._columnContainer));
                    }
                case Type DateTimeType when DateTimeType == typeof(DateTime):
                ...
                case Type ushortType when ushortType == typeof(ushort):
                    ...
                    else
                    {
                        ...
                        {
                            PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                            return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseEquals((column as PrimitiveDataFrameColumn<decimal>)._columnContainer));
                        }
                        else
                        {
                            PrimitiveDataFrameColumn<double> doubleColumn = CloneTruncating<double>();
                            return new PrimitiveDataFrameColumn<bool>(Name, doubleColumn._columnContainer.ElementwiseEquals(column.CloneTruncating<double>()._columnContainer));
                        }
                    }
                default:
                    throw new NotSupportedException();
        ...
        internal PrimitiveDataFrameColumn<bool> ElementwiseEqualsImplementation<U>(U value)
        {
            switch (typeof(T))
            {
                case Type boolType when boolType == typeof(bool):
                    ...
                    return new PrimitiveDataFrameColumn<bool>(Name, (this as PrimitiveDataFrameColumn<bool>)._columnContainer.ElementwiseEquals(Unsafe.As<U, bool>(ref value)));
                case Type decimalType when decimalType == typeof(decimal):
                    if (typeof(U) == typeof(bool))
                    {
                        throw new NotSupportedException();
                    ...
                    if (typeof(U) == typeof(T))
                    {
                        // No conversions
                        PrimitiveDataFrameColumn<T> primitiveColumn = this;
                        return new PrimitiveDataFrameColumn<bool>(Name, primitiveColumn._columnContainer.ElementwiseEquals(Unsafe.As<U, T>(ref value)));
                    }
                    else
                    {
                        PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                        return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseEquals(GetDecimalValue(value)));
                    }
                case Type DateTimeType when DateTimeType == typeof(DateTime):
                    if (typeof(U) != typeof(DateTime))
                    {
                ...
                case Type ushortType when ushortType == typeof(ushort):
                    ...
                    else
                    {
                        ...
                        {
                            PrimitiveDataFrameColumn<double> doubleColumn = CloneTruncating<double>();
                            return new PrimitiveDataFrameColumn<bool>(Name, doubleColumn._columnContainer.ElementwiseEquals(GetDoubleValue(value)));
                        }
                    }
                default:
                    throw new NotSupportedException();
            ...
            where U : unmanaged
        {
            ...
            switch (typeof(T))
            {
                case Type boolType when boolType == typeof(bool):
                    ...
                    return new PrimitiveDataFrameColumn<bool>(Name, (this as PrimitiveDataFrameColumn<U>)._columnContainer.ElementwiseNotEquals(column._columnContainer));
                case Type decimalType when decimalType == typeof(decimal):
                    if (typeof(U) == typeof(bool))
                    {
                        throw new NotSupportedException();
                    ...
                    if (typeof(U) == typeof(T))
                    {
                        // No conversions
                        PrimitiveDataFrameColumn<U> primitiveColumn = this as PrimitiveDataFrameColumn<U>;
                        return new PrimitiveDataFrameColumn<bool>(Name, primitiveColumn._columnContainer.ElementwiseNotEquals(column._columnContainer));
                    }
                    else
                    {
                        PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                        return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseNotEquals(column.CloneTruncating<decimal>()._columnContainer));
                    }
                case Type DateTimeType when DateTimeType == typeof(DateTime):
                    if (typeof(U) != typeof(DateTime))
                    {
                ...
                case Type ushortType when ushortType == typeof(ushort):
                    ...
                    else
                    {
                        ...
                        {
                            PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                            return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseNotEquals((column as PrimitiveDataFrameColumn<decimal>)._columnContainer));
                        }
                        else
                        {
                            PrimitiveDataFrameColumn<double> doubleColumn = CloneTruncating<double>();
                            return new PrimitiveDataFrameColumn<bool>(Name, doubleColumn._columnContainer.ElementwiseNotEquals(column.CloneTruncating<double>()._columnContainer));
                        }
                    }
                default:
                    throw new NotSupportedException();
        ...
        internal PrimitiveDataFrameColumn<bool> ElementwiseNotEqualsImplementation<U>(U value)
        {
            switch (typeof(T))
            {
                case Type boolType when boolType == typeof(bool):
                    ...
                    return new PrimitiveDataFrameColumn<bool>(Name, (this as PrimitiveDataFrameColumn<bool>)._columnContainer.ElementwiseNotEquals(Unsafe.As<U, bool>(ref value)));
                case Type decimalType when decimalType == typeof(decimal):
                    if (typeof(U) == typeof(bool))
                    {
                        throw new NotSupportedException();
                    ...
                    if (typeof(U) == typeof(T))
                    {
                        // No conversions
                        PrimitiveDataFrameColumn<T> primitiveColumn = this;
                        return new PrimitiveDataFrameColumn<bool>(Name, primitiveColumn._columnContainer.ElementwiseNotEquals(Unsafe.As<U, T>(ref value)));
                    }
                    else
                    {
                        PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                        return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseNotEquals(GetDecimalValue(value)));
                    }
                case Type DateTimeType when DateTimeType == typeof(DateTime):
                    if (typeof(U) != typeof(DateTime))
                    {
                ...
                case Type ushortType when ushortType == typeof(ushort):
                    ...
                    else
                    {
                        ...
                        {
                            PrimitiveDataFrameColumn<double> doubleColumn = CloneTruncating<double>();
                            return new PrimitiveDataFrameColumn<bool>(Name, doubleColumn._columnContainer.ElementwiseNotEquals(GetDoubleValue(value)));
                        }
                    }
                default:
                    throw new NotSupportedException();
            ...
            switch (typeof(T))
            {
                ...
                case Type decimalType when decimalType == typeof(decimal):
                    ...
                    if (typeof(U) == typeof(T))
                    {
                        // No conversions
                        PrimitiveDataFrameColumn<U> primitiveColumn = this as PrimitiveDataFrameColumn<U>;
                        return new PrimitiveDataFrameColumn<bool>(Name, primitiveColumn._columnContainer.ElementwiseGreaterThanOrEqual(column._columnContainer));
                    }
                    else
                    {
                        PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                        return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseGreaterThanOrEqual(column.CloneTruncating<decimal>()._columnContainer));
                    }
                case Type DateTimeType when DateTimeType == typeof(DateTime):
                    throw new NotSupportedException();
                case Type byteType when byteType == typeof(byte):
                ...
                case Type ushortType when ushortType == typeof(ushort):
                    ...
                    else
                    {
                        ...
                        {
                            PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                            return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseGreaterThanOrEqual((column as PrimitiveDataFrameColumn<decimal>)._columnContainer));
                        }
                        else
                        {
                            PrimitiveDataFrameColumn<double> doubleColumn = CloneTruncating<double>();
                            return new PrimitiveDataFrameColumn<bool>(Name, doubleColumn._columnContainer.ElementwiseGreaterThanOrEqual(column.CloneTruncating<double>()._columnContainer));
                        }
                    }
                default:
                    throw new NotSupportedException();
            ...
            switch (typeof(T))
            {
                ...
                case Type decimalType when decimalType == typeof(decimal):
                    ...
                    if (typeof(U) == typeof(T))
                    {
                        // No conversions
                        PrimitiveDataFrameColumn<T> primitiveColumn = this;
                        return new PrimitiveDataFrameColumn<bool>(Name, primitiveColumn._columnContainer.ElementwiseGreaterThanOrEqual(Unsafe.As<U, T>(ref value)));
                    }
                    else
                    {
                        PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                        return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseGreaterThanOrEqual(GetDecimalValue(value)));
                    }
                case Type DateTimeType when DateTimeType == typeof(DateTime):
                    throw new NotSupportedException();
                case Type byteType when byteType == typeof(byte):
                ...
                case Type ushortType when ushortType == typeof(ushort):
                    ...
                    else
                    {
                        ...
                        {
                            PrimitiveDataFrameColumn<double> doubleColumn = CloneTruncating<double>();
                            return new PrimitiveDataFrameColumn<bool>(Name, doubleColumn._columnContainer.ElementwiseGreaterThanOrEqual(GetDoubleValue(value)));
                        }
                    }
                default:
                    throw new NotSupportedException();
            ...
            switch (typeof(T))
            {
                ...
                case Type decimalType when decimalType == typeof(decimal):
                    ...
                    if (typeof(U) == typeof(T))
                    {
                        // No conversions
                        PrimitiveDataFrameColumn<U> primitiveColumn = this as PrimitiveDataFrameColumn<U>;
                        return new PrimitiveDataFrameColumn<bool>(Name, primitiveColumn._columnContainer.ElementwiseLessThanOrEqual(column._columnContainer));
                    }
                    else
                    {
                        PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                        return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseLessThanOrEqual(column.CloneTruncating<decimal>()._columnContainer));
                    }
                case Type DateTimeType when DateTimeType == typeof(DateTime):
                    throw new NotSupportedException();
                case Type byteType when byteType == typeof(byte):
                ...
                case Type ushortType when ushortType == typeof(ushort):
                    ...
                    else
                    {
                        ...
                        {
                            PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                            return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseLessThanOrEqual((column as PrimitiveDataFrameColumn<decimal>)._columnContainer));
                        }
                        else
                        {
                            PrimitiveDataFrameColumn<double> doubleColumn = CloneTruncating<double>();
                            return new PrimitiveDataFrameColumn<bool>(Name, doubleColumn._columnContainer.ElementwiseLessThanOrEqual(column.CloneTruncating<double>()._columnContainer));
                        }
                    }
                default:
                    throw new NotSupportedException();
            ...
            switch (typeof(T))
            {
                ...
                case Type decimalType when decimalType == typeof(decimal):
                    ...
                    if (typeof(U) == typeof(T))
                    {
                        // No conversions
                        PrimitiveDataFrameColumn<T> primitiveColumn = this;
                        return new PrimitiveDataFrameColumn<bool>(Name, primitiveColumn._columnContainer.ElementwiseLessThanOrEqual(Unsafe.As<U, T>(ref value)));
                    }
                    else
                    {
                        PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                        return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseLessThanOrEqual(GetDecimalValue(value)));
                    }
                case Type DateTimeType when DateTimeType == typeof(DateTime):
                    throw new NotSupportedException();
                case Type byteType when byteType == typeof(byte):
                ...
                case Type ushortType when ushortType == typeof(ushort):
                    ...
                    else
                    {
                        ...
                        {
                            PrimitiveDataFrameColumn<double> doubleColumn = CloneTruncating<double>();
                            return new PrimitiveDataFrameColumn<bool>(Name, doubleColumn._columnContainer.ElementwiseLessThanOrEqual(GetDoubleValue(value)));
                        }
                    }
                default:
                    throw new NotSupportedException();
            ...
            switch (typeof(T))
            {
                ...
                case Type decimalType when decimalType == typeof(decimal):
                    ...
                    if (typeof(U) == typeof(T))
                    {
                        // No conversions
                        PrimitiveDataFrameColumn<U> primitiveColumn = this as PrimitiveDataFrameColumn<U>;
                        return new PrimitiveDataFrameColumn<bool>(Name, primitiveColumn._columnContainer.ElementwiseGreaterThan(column._columnContainer));
                    }
                    else
                    {
                        PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                        return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseGreaterThan(column.CloneTruncating<decimal>()._columnContainer));
                    }
                case Type DateTimeType when DateTimeType == typeof(DateTime):
                    throw new NotSupportedException();
                case Type byteType when byteType == typeof(byte):
                ...
                case Type ushortType when ushortType == typeof(ushort):
                    ...
                    else
                    {
                        ...
                        {
                            PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                            return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseGreaterThan((column as PrimitiveDataFrameColumn<decimal>)._columnContainer));
                        }
                        else
                        {
                            PrimitiveDataFrameColumn<double> doubleColumn = CloneTruncating<double>();
                            return new PrimitiveDataFrameColumn<bool>(Name, doubleColumn._columnContainer.ElementwiseGreaterThan(column.CloneTruncating<double>()._columnContainer));
                        }
                    }
                default:
                    throw new NotSupportedException();
            ...
            switch (typeof(T))
            {
                ...
                case Type decimalType when decimalType == typeof(decimal):
                    ...
                    if (typeof(U) == typeof(T))
                    {
                        // No conversions
                        PrimitiveDataFrameColumn<T> primitiveColumn = this;
                        return new PrimitiveDataFrameColumn<bool>(Name, primitiveColumn._columnContainer.ElementwiseGreaterThan(Unsafe.As<U, T>(ref value)));
                    }
                    else
                    {
                        PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                        return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseGreaterThan(GetDecimalValue(value)));
                    }
                case Type DateTimeType when DateTimeType == typeof(DateTime):
                    throw new NotSupportedException();
                case Type byteType when byteType == typeof(byte):
                ...
                case Type ushortType when ushortType == typeof(ushort):
                    ...
                    else
                    {
                        ...
                        {
                            PrimitiveDataFrameColumn<double> doubleColumn = CloneTruncating<double>();
                            return new PrimitiveDataFrameColumn<bool>(Name, doubleColumn._columnContainer.ElementwiseGreaterThan(GetDoubleValue(value)));
                        }
                    }
                default:
                    throw new NotSupportedException();
            ...
            switch (typeof(T))
            {
                ...
                case Type decimalType when decimalType == typeof(decimal):
                    ...
                    if (typeof(U) == typeof(T))
                    {
                        // No conversions
                        PrimitiveDataFrameColumn<U> primitiveColumn = this as PrimitiveDataFrameColumn<U>;
                        return new PrimitiveDataFrameColumn<bool>(Name, primitiveColumn._columnContainer.ElementwiseLessThan(column._columnContainer));
                    }
                    else
                    {
                        PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                        return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseLessThan(column.CloneTruncating<decimal>()._columnContainer));
                    }
                case Type DateTimeType when DateTimeType == typeof(DateTime):
                    throw new NotSupportedException();
                case Type byteType when byteType == typeof(byte):
                ...
                case Type ushortType when ushortType == typeof(ushort):
                    ...
                    else
                    {
                        ...
                        {
                            PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                            return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseLessThan((column as PrimitiveDataFrameColumn<decimal>)._columnContainer));
                        }
                        else
                        {
                            PrimitiveDataFrameColumn<double> doubleColumn = CloneTruncating<double>();
                            return new PrimitiveDataFrameColumn<bool>(Name, doubleColumn._columnContainer.ElementwiseLessThan(column.CloneTruncating<double>()._columnContainer));
                        }
                    }
                default:
                    throw new NotSupportedException();
            ...
            switch (typeof(T))
            {
                ...
                case Type decimalType when decimalType == typeof(decimal):
                    ...
                    if (typeof(U) == typeof(T))
                    {
                        // No conversions
                        PrimitiveDataFrameColumn<T> primitiveColumn = this;
                        return new PrimitiveDataFrameColumn<bool>(Name, primitiveColumn._columnContainer.ElementwiseLessThan(Unsafe.As<U, T>(ref value)));
                    }
                    else
                    {
                        PrimitiveDataFrameColumn<decimal> decimalColumn = CloneTruncating<decimal>();
                        return new PrimitiveDataFrameColumn<bool>(Name, decimalColumn._columnContainer.ElementwiseLessThan(GetDecimalValue(value)));
                    }
                case Type DateTimeType when DateTimeType == typeof(DateTime):
                    throw new NotSupportedException();
                case Type byteType when byteType == typeof(byte):
                ...
                case Type ushortType when ushortType == typeof(ushort):
                    ...
                    else
                    {
                        ...
                        {
                            PrimitiveDataFrameColumn<double> doubleColumn = CloneTruncating<double>();
                            return new PrimitiveDataFrameColumn<bool>(Name, doubleColumn._columnContainer.ElementwiseLessThan(GetDoubleValue(value)));
                        }
                    }
                default:
                    throw new NotSupportedException();
